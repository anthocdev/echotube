...
export default function Terms() {
  ...
  const TermsText = (
    <div style={{ textAlign: "center" }}>
      <h2>Welcome to EchoTube</h2>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of EchoTube's Website.
      </p>{" "}
      <br />
      <span style={{ textTransform: "capitalize" }}> EchoTube</span>{" "}
      <p>
        By accessing this website we assume you accept these terms and
        conditions in full. Do not continue to use EchoTube's website if you do
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By using EchoTube's website you consent to
        the use of cookies in accordance with EchoTube's privacy policy.
      </p>
      <p>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, EchoTube and/or it's licensors own the
        intellectual property rights for all material on EchoTube. All
        intellectual property rights are reserved. You may view and/or print
        pages from http://EchoTube.com for your own personal use subject to
        restrictions set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ol>
        <li>Republish material from http://EchoTube.com</li>
        <li>Sell, rent or sub-license material from http://EchoTube.com</li>
        <li>Reproduce, duplicate or copy material from http://EchoTube.com</li>
      </ol>
      <p>
        Redistribute content from EchoTube (unless content is specifically made
        for redistribution).
      </p>
      ...
      <p>
        ...
        EchoTube; and (d) where the link is in the context of general resource
      ...
      <p>
        ...
        e-mail to{" "}
        <a
          href="mailto:anthocdev@gmail.com"
          title="send an email to anthocdev@gmail.com"
        >
          anthocdev@gmail.com
        </a>
      ...
      <p>
        No use of EchoTube's logo or other artwork will be allowed for linking
